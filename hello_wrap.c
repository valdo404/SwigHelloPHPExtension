...
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(hello_globals_id, zend_hello_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(hello_globals_id, zend_hello_globals *, error_code )
#else
#define SWIG_ErrorMsg() (hello_globals.error_msg)
#define SWIG_ErrorCode() (hello_globals.error_code)
#endif
...
static void hello_init_globals(zend_hello_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void hello_destroy_globals(zend_hello_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_hello_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_hello_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
/* wrapper section */
ZEND_NAMED_FUNCTION(_wrap_print_hello) {
  char *result = 0 ;
...
static zend_function_entry hello_functions[] = {
 SWIG_ZEND_NAMED_FE(print_hello,_wrap_print_hello,NULL)
 SWIG_ZEND_NAMED_FE(swig_hello_alter_newobject,_wrap_swig_hello_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_hello_get_newobject,_wrap_swig_hello_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
zend_module_entry* SWIG_module_entry = &hello_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &hello_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(hello)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(hello, hello_init_globals, hello_destroy_globals);
